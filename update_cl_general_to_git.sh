...
for tname in examination profile report sample_id_strategy dashboard super_profile copy_bin_text view_info_data prototype prototype_data host_code lab_reference_value
do
