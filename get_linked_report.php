...
$released=get_one_ex_result($link,$sample_id,$GLOBALS['released_by']);
$interim_released=get_one_ex_result($link,$sample_id,$GLOBALS['interim_released_by']);
...
print_sample($link,$sample_id,$pdf);
...
{
	$ex_result=get_one_ex_result_blob($link,$sample_id,$ar['examination_id']);
